...
const Button = ({ title, number, onClick, bgColor }) => {
  ...
  return (
    <button
      ...
      onClick={onClick}
      target="_blank"
      className="flex sm:-order-2 align-item mt-5 p-4 border border-[#393950] hover:bg-[#38384F] text-left font-body font-semibold text-xl animate-[fade-in-down_1.5s_ease-out]"
    >
