...
const Cards = ({ planetData }) => {
  return (
    <div className="container flex justify-around mx-auto mt-10 ">
      <div className="border border-[#20203a] flex flex-col justify-center text-white w-56 h-32 pl-5 py-3 animate-[fade-in-down_1s_ease-out]	">
      ...
      <div className="border border-[#20203a] flex flex-col justify-center text-white w-56 h-32 pl-5 py-3 animate-[fade-in-down_1.5s_ease-out]">
      ...
      <div className="border border-[#20203a] flex flex-col justify-center text-white w-56 h-32 pl-5 py-3 animate-[fade-in-down_2.3s_ease-out]">
