...
const Cards = ({ planetData }) => {
  return (
    <div className="container flex  justify-center items-center lg:justify-around mx-auto mt-10 flex-col p-3 lg:flex-row ">
      <div className="border border-[#20203a] flex flex-col justify-center text-white w-8/12 h-11/12 lg:w-56 lg:h-32 lg:pl-5 py-3 animate-[fade-in-down_2s_ease-out] mb-2">
